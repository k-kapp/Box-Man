...
namespace BoxMan
{
    public class PopupDialog : XNAForm
    {
        ...
        public static PopupDialog MakePopupDialog(string message, string title, bool buttonsAutoSize, StateBase stateMgr)
        {
            ...
            return new BoxMan.PopupDialog(message, 0, 0, width, height, title, buttonsAutoSize, stateMgr);
        }
        ...
        private void _initialize()
        {
            ...
            */
            ...
            _messageLabel = new BoxMan.XNALabel(_message, _font, new Vector2(0, _textY), 1.0f, this);
        ...
        {
            Button newButton = new BoxMan.Button(text, 0, 0, _buttonsWidth, _buttonsHeight, this);
